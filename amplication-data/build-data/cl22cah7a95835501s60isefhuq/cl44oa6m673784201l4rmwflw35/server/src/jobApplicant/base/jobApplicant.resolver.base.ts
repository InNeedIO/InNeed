...
export class JobApplicantResolverBase {
  ...
  async createJobApplicant(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        job_offering_id: {
          connect: args.data.job_offering_id,
        },
  ...
  async jobOfferingId(
    ...
    const result = await this.service.getJobOfferingId(parent.id);
  ...
  async userId(@graphql.Parent() parent: JobApplicant): Promise<User | null> {
